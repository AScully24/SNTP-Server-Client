...
${OBJECTDIR}/manycast-client.o: manycast-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/manycast-client.o manycast-client.c

${OBJECTDIR}/manycast-server.o: manycast-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/manycast-server.o manycast-server.c

${OBJECTDIR}/ntp_time_conversion.o: ntp_time_conversion.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ntp_time_conversion.o ntp_time_conversion.c

${OBJECTDIR}/unicast-client.o: unicast-client.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unicast-client.o unicast-client.c

${OBJECTDIR}/unicast-server.o: unicast-server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unicast-server.o unicast-server.c
